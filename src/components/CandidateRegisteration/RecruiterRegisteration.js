                    ...
                    <form method="POST" className=" needs-validation" novalidate>
                        ...
                        <div className="row">
                            ...
                            <div className="col">
                                ...
                                <input type="text" className="form-control" placeholder="Company Email Address" name="email" value={recruiter.email} onChange={handleInputs} aria-label="Last name" required />
                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <input type="text" className="form-control" placeholder="Address" name="address" aria-label="First name" value={recruiter.address} onChange={handleInputs} required />

                                <div className="invalid-feedback">
                                    Please provide your Company office Address.
                                </div>
                            </div>
                            <div className="col">
                                <label for="exampleFormControlInput1" className="form-label">Contact Number</label>
                                <input type="tel" className="form-control" placeholder="Contact Number 92-321-1234567" name="phonenumber" value={recruiter.phonenumber} pattern="[0-9]{2}-[0-9]{3}-[0-9]{7}" onChange={handleInputs} aria-label="Last name" required />
                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <input type="password" className="form-control" placeholder="Password" name="password" aria-label="First name" value={recruiter.password} onChange={handleInputs} required />
                            ...
                            <div className="col">
                                ...
                                <input type="password" className="form-control" placeholder="Reenter Password" name="cpassword" aria-label="Last name" value={recruiter.cpassword} onChange={handleInputs} required />
                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <select className="form-select" id="validationCustom04" required name="country" value={recruiter.country} onChange={handleInputs}>
                        ...
                        <br></br>
                        <button type="button" className="btn btn-outline-primary" onClick={PostData}>Register as Recruiter</button>
